...
const DefaultDetails = require("../models/defaultImages");
          ...
          if (user) {
            ...
            const { getNextSequenceValueNew } = require("./functional");
              ...
              if (type == "profile") {
                ...
                defId + "_" + splittedImageName[0] + "." + extension;
                const fileLocation =
                  "uploads/defaultProfileImages/" + modifiedImageName;
                var ContentType;
                ...
                const  detail = new  DefaultDetails ({
                  d_Id : defId,
                  profileImage : modifiedImageName,
                });
                await detail
                  .save()
                  .then((data) => {
